...
import com.kirson.baseproject.components.Checkbox
...
fun OptionSelector(
  ...
  Column(modifier = modifier.background(BaseProjectAppTheme.colors.backgroundSecondary)) {
    SheetHandle()
...
internal fun OptionSelectorRow(
  ...
  Row(
    ...
    Text(
      ...
      style = BaseProjectAppTheme.typography.caption3,
      text = text,
    )
    if (checked) {
      Checkbox(
