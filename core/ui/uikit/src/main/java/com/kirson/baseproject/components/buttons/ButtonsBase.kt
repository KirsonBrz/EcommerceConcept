...
internal fun ButtonText(
  ...
  Text(
    ...
    style = when (size) {
      ButtonSize.Normal -> BaseProjectAppTheme.typography.button1
      ButtonSize.Small -> BaseProjectAppTheme.typography.button2
    },
    text = text,
  )
}
...
internal object ButtonDefaults {
  ...
  fun primaryButtonColors(): ButtonColors {
    return ButtonColors(
      ...
      contentColor = BaseProjectAppTheme.colors.primaryButton,
      disabledBackgroundColor = BaseProjectAppTheme.colors.textTertiary,
      disabledContentColor = BaseProjectAppTheme.colors.textTertiary,
    )
  }
  ...
  fun secondaryButtonColors(): ButtonColors {
    return ButtonColors(
      backgroundColor = BaseProjectAppTheme.colors.contendSecondary,
      contentColor = BaseProjectAppTheme.colors.textPrimary,
      disabledBackgroundColor = BaseProjectAppTheme.colors.contendSecondary,
      disabledContentColor = BaseProjectAppTheme.colors.textTertiary,
    )
  }
  ...
  fun positiveButtonColors(): ButtonColors {
    return ButtonColors(
      backgroundColor = Color.Transparent,
      contentColor = BaseProjectAppTheme.colors.textPrimary,
      disabledBackgroundColor = BaseProjectAppTheme.colors.contendTertiary,
      disabledContentColor = BaseProjectAppTheme.colors.textTertiary,
    )
  }
  ...
  fun topAppBarButtonColors(
    contentColor: Color = BaseProjectAppTheme.colors.textPrimary,
  ): ButtonColors {
    return ButtonColors(
      backgroundColor = Color.Transparent,
  ...
  fun unselectedChipButtonColors(): ButtonColors {
    return ButtonColors(
      backgroundColor = Color.Transparent,
      contentColor = BaseProjectAppTheme.colors.textSecondary,
      disabledBackgroundColor = Color.Transparent,
      disabledContentColor = BaseProjectAppTheme.colors.textTertiary,
    )
  }
