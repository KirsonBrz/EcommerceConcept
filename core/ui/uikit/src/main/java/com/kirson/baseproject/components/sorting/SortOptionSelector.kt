...
import com.kirson.baseproject.components.buttons.SecondaryButton
...
fun SortOptionSelector(
  ...
  Column(
    modifier = modifier
      .background(BaseProjectAppTheme.colors.backgroundPrimary)
      ...
      SecondaryButtonSmall(
        ...
        icon = {
          ...
          Icon(
            ...
            tint = BaseProjectAppTheme.colors.textPrimary,
          )
        },
